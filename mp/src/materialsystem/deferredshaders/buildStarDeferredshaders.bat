...
set GAMEDIR=C:\STARDU~2\game\stardust
...
set SDKBINDIR=C:\STARDU~2\game\bin

rem ==  Set the Path to your mods root source code ==
rem this should already be correct, accepts relative paths only!
set SOURCEDIR=C:\STARDU~2\src
...
rem // BUILD PBR
REM %BUILD_SHADER% pbr/pbr_dx9_20b		-game %GAMEDIR% -source %SOURCEDIR%
REM %BUILD_SHADER% pbr/pbr_dx9_30		-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30

rem // BUILD GAME
rem %BUILD_SHADER% stdshader_dx9_20b_new_wars		-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	
%BUILD_SHADER% stdshader_dx9_30_deferred		-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30 
