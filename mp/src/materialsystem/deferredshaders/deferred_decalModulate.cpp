...
SHADER_DRAW
{
    ...
    if ( pShaderAPI != NULL && ( iDeferredRenderStage != DEFERRED_RENDER_STAGE_GBUFFER && bDeferredShading ||
    ...
    DYNAMIC_STATE
    {
        ...
        if ( bHasFastVertexTextures )
            SetHWMorphVertexShaderState( VERTEX_SHADER_SHADER_SPECIFIC_CONST_6, VERTEX_SHADER_SHADER_SPECIFIC_CONST_7,
